                            ...
                            <table class="table_registro">
                                ...
                                //Validamos click al boton
                                    ...
                                    if (!$conn) {
                                        ...
                                        $sql = "SELECT Consulta.fecha, users.nombre, Consulta.id_paciente, Consulta.enfermedad_registrada, Consulta.observaciones FROM Consulta INNER JOIN users ON Consulta.id_paciente = users.usuario WHERE Consulta.id_medico = '$usuario'";
